...
class ConcreteOnlineStore extends OnlineStore {
    ...
    public void displayProduct() {
        ...
        for(Product product: mediator.getProductList()){
            ...
            System.out.println(i+".Displaying product: " );
            //temp to show product
            AbstractProductListing abstractProductListing=new ConcreteProductListing(product);
